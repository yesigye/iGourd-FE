...
import type { BasicOption, Recordable } from '@igourd/types';

import { computed, markRaw, useTemplateRef } from 'vue';

import { AuthenticationLogin, SliderCaptcha, z } from '@igourd/common-ui';
  ...
  return [
    {
      ...
      //     placeholder: $t('authentication.select-account'),
      //   };
      // },
      componentProps: {
        options: MOCK_USER_OPTIONS,
      ...
      label: $t('authentication.select-account'),
      rules: z
        .string()
        .min(1, { message: $t('authentication.select-account') })
        .optional()
        .default('igourd'),
    },
    {
    ...
    },
    {
      ...
      rules: z.boolean().refine((value) => value, {
        message: $t('authentication.verify-required-tip'),
      }),
    },
  ];
});
