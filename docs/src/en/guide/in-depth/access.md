...
With the permission codes, you can use the `AccessControl` component and API provided by `@igourd/access` to show and hide buttons.

#### Component Method

```vue
<script lang="ts" setup>
import { AccessControl, useAccess } from '@igourd/access';
...
```vue
<script lang="ts" setup>
import { AccessControl } from '@igourd/access';
</script>
