...
import { updatePreferences } from '@igourd/preferences';
...
- Do not place business translation texts inside `@igourd/locales` to better manage business and general translation texts.
...
{
  "about": {
    "desc": "Igourd Admin is a modern management template."
  }
}
````
...
With `@igourd/locales`, you can easily use translation texts:
