...
```json
{
  "scripts": {
    ...
    "build:antd": "pnpm run build --filter=@igourd/web-antd",
    // Build the documentation separately
    "build:docs": "pnpm run build --filter=@igourd/docs",
    // Build the web-ele application separately
    "build:ele": "pnpm run build --filter=@igourd/web-ele",
    // Build the web-naive application separately
    "build:naive": "pnpm run build --filter=@igourd/naive",
    // Build the playground application separately
    "build:play": "pnpm run build --filter=@igourd/playground",
    ...
    "dev:antd": "pnpm -F @igourd/web-antd run dev",
    // Start the documentation
    "dev:docs": "pnpm -F @igourd/docs run dev",
    // Start the web-ele application
    "dev:ele": "pnpm -F @igourd/web-ele run dev",
    // Start the web-naive application
    "dev:naive": "pnpm -F @igourd/web-naive run dev",
    // Start the playground application
    "dev:play": "pnpm -F @igourd/playground run dev",
    // Format code
...
Take the addition of the test environment `test` to `@igourd/web-antd` as an example:
...
"scripts": {
    ...
    "build:analyze": "turbo build:analyze",
    "build:antd": "pnpm run build --filter=@igourd/web-antd",
    "build-test:antd": "pnpm run build --filter=@igourd/web-antd build:test",
...
"tasks": {
    ...
    "build-test:antd": {
      "dependsOn": ["@igourd/web-antd#build:test"],
      "outputs": ["dist/**"]
    },

    "@igourd/web-antd#build:test": {
      "dependsOn": ["^build"],
      "outputs": ["dist/**"]
    },
