...
- The icons in the project are mainly provided by the `@igourd/icons` package. It is recommended to manage them within this package for unified management and maintenance.
...
import { MdiKeyboardEsc } from '@igourd/icons';
</script>
...
```vue
<script setup lang="ts">
import { SvgTestIcon } from '@igourd/icons';
</script>
