...
import { alert, confirm, IgourdButton } from '@igourd/common-ui';
...
<template>
  <div class="flex gap-4">
    <IgourdButton @click="showConfirm">Confirm</IgourdButton>
    <IgourdButton @click="showIconConfirm">Confirm With Icon</IgourdButton>
    <IgourdButton @click="showfooterConfirm">Confirm With Footer</IgourdButton>
    <IgourdButton @click="showAsyncConfirm">Async Confirm</IgourdButton>
  </div>
</template>
