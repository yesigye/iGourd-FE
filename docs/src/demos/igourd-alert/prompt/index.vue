...
import { alert, prompt, useAlertContext, IgourdButton } from '@igourd/common-ui';
...
<template>
  <div class="flex gap-4">
    <IgourdButton @click="showPrompt">Prompt</IgourdButton>
    <IgourdButton @click="showSlotsPrompt"> Prompt With slots </IgourdButton>
    <IgourdButton @click="showSelectPrompt">Prompt With Select</IgourdButton>
    <IgourdButton @click="showAsyncPrompt">Prompt With Async</IgourdButton>
  </div>
</template>
