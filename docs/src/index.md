...
hero:
  ...
  image:
    src: https://unpkg.com/@igourdjs/static-source@0.1.7/source/logo-v1.webp
    alt: Igourd Admin
  actions:
    - theme: brand
      text: 快速开始 ->
    ...
    - theme: alt
      text: DeepWiki 文档
      link: https://deepwiki.com/igourdjs/vue-igourd-admin
...
const members = [
  {
    ...
    name: 'Igourd',
    title: '创建者',
    desc: 'Igourd Admin以及相关生态的作者，负责项目的整体开发。',
    links: [
