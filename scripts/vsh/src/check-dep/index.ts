...
import { getPackages } from '@igourd/node-utils';
...
const DEFAULT_CONFIG = {
  ...
  ignorePackages: [
    '@igourd/backend-mock',
    '@igourd/commitlint-config',
    '@igourd/eslint-config',
    '@igourd/node-utils',
    '@igourd/prettier-config',
    '@igourd/stylelint-config',
    '@igourd/tailwind-config',
    '@igourd/tsconfig',
    '@igourd/vite-config',
    '@igourd/vsh',
