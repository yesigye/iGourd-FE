...
export const PreviousOutlined = createIconifyIcon('weui:previous-outlined');
export const ReceiptCheck = createIconifyIcon('streamline:receipt-check');
export const GoodsOutline = createIconifyIcon('lsicon:goods-outline');
export const ReceiptRefund = createIconifyIcon('heroicons:receipt-refund');
export const TransferVan = createIconifyIcon('streamline:transfer-van');
export const WebWindowEnergyConsumption = createIconifyIcon(
  'iconoir:web-window-energy-consumption',
);
export const ManagementStockoutOutline = createIconifyIcon(
  'lsicon:management-stockout-outline',
);
export const ShoppingBagHandBag2ShoppingBagPurseGoodsItemProducts =
  createIconifyIcon(
