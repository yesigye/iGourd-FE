...
import type { Recordable } from '@igourd-core/typings';
...
export function igourdAlert(options: AlertProps): Promise<void>;
export function igourdAlert(
  message: string,
...
export function igourdConfirm(options: AlertProps): Promise<void>;
export function igourdConfirm(
  message: string,
  options?: Partial<AlertProps>,
): Promise<void>;
export function igourdConfirm(
...
export function igourdConfirm(
  ...
  if (!arg1) {
    return isString(arg0)
      ? igourdAlert(arg0, defaultProps)
      : igourdAlert({ ...defaultProps, ...arg0 });
  } else if (!arg2) {
    return isString(arg1)
      ? igourdAlert(arg0 as string, arg1, defaultProps)
      : igourdAlert(arg0 as string, { ...defaultProps, ...arg1 });
  }
  return igourdAlert(arg0 as string, arg1 as string, {
    ...defaultProps,
    ...arg2,
  });
}

export async function igourdPrompt<T = any>(
  ...
  staticContents.push(h(IgourdRenderContent, { content, renderBr: true }));
