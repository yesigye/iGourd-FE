      ...
      <div :class="cn('relative flex-1 overflow-y-auto p-3', contentClass)">
        ...
        <AlertDialogDescription>
          <div class="m-4 min-h-[30px]">
            <IgourdRenderContent :content="content" render-br />
          </div>
          <IgourdLoading v-if="loading && contentMasking" :spinning="loading" />
        </AlertDialogDescription>
        <div
          class="flex items-center justify-end gap-x-2"
          :class="`justify-${buttonAlign}`"
        >
          <IgourdRenderContent :content="footer" />
          <AlertDialogCancel v-if="showCancel" as-child>
            <component
              :is="components.DefaultButton || IgourdButton"
              :disabled="loading"
              variant="ghost"
              @click="handleCancel"
            >
          ...
          <AlertDialogAction as-child>
            <component
              :is="components.PrimaryButton || IgourdButton"
              :loading="loading"
              @click="handleConfirm"
            >
