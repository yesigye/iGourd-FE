...
import type { TabDefinition } from '@igourd-core/typings';

import type { TabConfig, TabsProps } from '../../types';

import { computed, ref } from 'vue';

import { Pin, X } from '@igourd-core/icons';
import { IgourdContextMenu, IgourdIcon } from '@igourd-core/shadcn-ui';

interface Props extends TabsProps {}

defineOptions({
  name: 'IgourdTabsChrome',
  inheritAttrs: false,
});

const props = withDefaults(defineProps<Props>(), {
  contentClass: 'igourd-tabs-content',
  contextMenus: () => [],
  gap: 7,
  tabs: () => [],
});
