...
import { useForwardPropsEmits } from '@igourd-core/composables';
import { ChevronLeft, ChevronRight } from '@igourd-core/icons';
import { IgourdScrollbar } from '@igourd-core/shadcn-ui';
