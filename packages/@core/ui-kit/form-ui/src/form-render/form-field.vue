...
import { CircleAlert } from '@igourd-core/icons';
import {
  FormControl,
  FormDescription,
  FormField,
...
import { cn, isFunction, isObject, isString } from '@igourd-core/shared/utils';
...
<template>
  ...
  >
    ...
    >
      ...
      >
        <template v-if="label">
          <IgourdRenderContent :content="label" />
        </template>
      </FormLabel>
      <div class="flex-auto overflow-hidden p-[1px]">
        <div :class="cn('relative flex w-full items-center', wrapperClass)">
          ...
          <div v-if="suffix" class="ml-1">
            <IgourdRenderContent :content="suffix" />
          </div>
          <FormDescription v-if="description" class="ml-1">
            <IgourdRenderContent :content="description" />
          </FormDescription>
        </div>
