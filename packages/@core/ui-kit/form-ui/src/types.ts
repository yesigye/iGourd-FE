...
import type { IgourdButtonProps } from '@igourd-core/shadcn-ui';
...
export interface ActionButtonOptions extends IgourdButtonProps {
  [key: string]: any;
  content?: MaybeComputedRef<string>;
  show?: boolean;
}

export interface IgourdFormProps<
  T extends BaseFormComponentType = BaseFormComponentType,
> extends Omit<
    FormRenderProps<T>,
...
export type ExtendedFormApi = FormApi & {
  useStore: <T = NoInfer<IgourdFormProps>>(
    selector?: (state: NoInfer<IgourdFormProps>) => T,
  ) => Readonly<Ref<T>>;
};

export interface IgourdFormAdapterOptions<
  T extends BaseFormComponentType = BaseFormComponentType,
> {
  config?: {
