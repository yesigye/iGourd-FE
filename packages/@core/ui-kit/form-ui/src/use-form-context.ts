...
import type { ExtendedFormApi, FormActions, IgourdFormProps } from './types';
...
type ExtendFormProps = IgourdFormProps & { formApi: ExtendedFormApi };
...
export function useFormInitial(
  props: ComputedRef<IgourdFormProps> | IgourdFormProps,
) {
