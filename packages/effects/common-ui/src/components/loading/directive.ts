...
import { IgourdLoading, IgourdSpinner } from '@igourd-core/shadcn-ui';
import { isString } from '@igourd-core/shared/utils';
...
const loadingDirective: Directive = {
  mounted(el, binding) {
    const instance = h(IgourdLoading, getOptions(binding));
    render(instance, el);
...
const spinningDirective: Directive = {
  mounted(el, binding) {
    const instance = h(IgourdSpinner, getOptions(binding));
    render(instance, el);
