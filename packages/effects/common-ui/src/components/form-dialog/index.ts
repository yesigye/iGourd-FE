...
type FormDialogContent = ((props: FormDialogContentProps) => VNode) | Component;

type DialogTitle = (() => VNode) | Component | number | string | VNode;
...
export function FormDialog(
  title: DialogTitle | IFormDialogProps,
  content: FormDialogContent,
): IFormDialog;
...
export function FormDialog(
  title: DialogTitle | IFormDialogProps,
  id: FormDialogContent | string | symbol,
  content?: FormDialogContent,
): IFormDialog {
