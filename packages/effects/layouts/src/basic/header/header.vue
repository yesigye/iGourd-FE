...
import { RotateCw } from '@igourd/icons';
import { preferences, usePreferences } from '@igourd/preferences';
import { useAccessStore } from '@igourd/stores';

import { IgourdFullScreen, IgourdIconButton } from '@igourd-core/shadcn-ui';
  ...
  >
    <slot :name="slot.name">
      <template v-if="slot.name === 'refresh'">
        <IgourdIconButton class="my-0 mr-1 rounded-md" @click="refresh">
