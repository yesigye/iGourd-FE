...
import type { TabDefinition } from '@igourd/types';

import type { IContextMenuItem } from '@igourd-core/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@igourd/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { getTabKey, useAccessStore, useTabbarStore } from '@igourd/stores';
import { filterTree } from '@igourd/utils';
