...
import { LockKeyhole } from '@igourd/icons';
...
const [Form, { form, validate }] = useIgourdForm(
  reactive({
    commonConfig: {
      hideLabel: true,
    ...
    <transition name="slide-right">
      ...
      >
        <div class="flex-col-center mb-10 w-[90%] max-w-[300px] px-4">
          <IgourdAvatar :src="avatar" class="enter-x mb-6 size-20" />
          <div class="enter-x mb-2 w-full items-center">
            <Form />
          </div>
          <IgourdButton class="enter-x w-full" @click="handleSubmit">
