...
import { Bell, MailCheck } from '@igourd/icons';
  ...
  >
    <template #trigger>
      <div class="flex-center mr-2 h-full" @click.stop="toggle()">
        <IgourdIconButton class="bell-button text-foreground relative">
          <span
            v-if="dot"
    ...
    <div class="relative">
      ...
      <IgourdScrollbar v-if="notifications.length > 0">
      ...
      >
        ...
        <IgourdButton size="sm" @click="handleViewAll">
