export interface RootObject {
  ...
  payment_order_item_list: advancePaymentOrderItem[];
...
export interface advancePaymentOrderItem {
  account_id: number;
...
export interface advancePaymentOrderDetails {
  merchant_id: number;
  payment_order_id: number;
}
export interface advancePaymentOrderModifyV0 {
  actual_amount: number;
  attachment_url: string;
  business_type: string;
  currency_code: string;
...
export interface advancePaymentOrderRemoveV0 {
  merchant_id: number;
  payment_order_ids: number[];
}
export interface advancePaymentOrderReviewStatusModifyV0 {
  id: number;
  merchant_id: number;
