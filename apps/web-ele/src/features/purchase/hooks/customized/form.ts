...
import { createOrUpdateCustomizedField } from '@@/purchase/apis';
import type { ISchema } from '@igourd/common-ui';
import { useDrawerForm } from '#/hooks/use-drawer-form';
import type { PurchaseCustomizedFormData } from './types';
...
const handleSubmit = async (values: PurchaseCustomizedFormData) => {
  ...
  // 调用 API
  await createOrUpdateCustomizedField(formattedValues);
};
