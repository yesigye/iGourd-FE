...
import { StoreSettingsDrawer, StoreSettingsDetail } from '../../components';
...
const [Drawer, drawerApi] = useIgourdDrawer({
  connectedComponent: StoreSettingsDrawer,
});
...
// 处理保存
const handleSaveAction = (row: any) => {
  handleSave(row);
};
