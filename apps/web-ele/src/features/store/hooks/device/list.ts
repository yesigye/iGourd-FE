  ...
  const baseColumns: VxeGridPropTypes.Column<any>[] = [
    {
      ...
      align: 'left',
      fixed: 'left',
      title: t('store-device.name'),
    },
    {
      field: 'code',
      minWidth: 150,
      align: 'left',
      title: t('store-device.code'),
    },
    {
      field: 'short_name',
      minWidth: 120,
      align: 'center',
      title: t('store-device.short-name'),
      formatter({ row }) {
    ...
    },
    {
      ...
      minWidth: 100,
      align: 'center',
      title: t('store-device.storename'),
      formatter({ row }) {
    ...
    },
    {
      ...
      minWidth: 150,
      align: 'left',
      title: t('store-device.mac-address'),
    },
    {
      field: 'ip_address',
      minWidth: 100,
      align: 'center',
      title: t('store-device.ip-address'),
    },
    {
      title: t('store-device.last-login-time'),
    ...
    },
    {
      ...
      minWidth: 200,
      align: 'left',
      title: t('store-device.login-count'),
    },
    {
      field: 'software_version',
      minWidth: 180,
      align: 'center',
      title: t('store-device.software-version'),
    },
    {
      title: t('store-device.version-update-time'),
    ...
    },
    {
      ...
      minWidth: 180,
      align: 'center',
      title: t('store-device.os-version'),
    },
    {
      field: 'type',
      minWidth: 180,
      align: 'center',
      title: t('store-device.type'),
    },
    {
      field: 'is_authorized',
      minWidth: 180,
      align: 'center',
      fixed: 'right',
      title: t('store-device.is-authorized'),
      slots: {
