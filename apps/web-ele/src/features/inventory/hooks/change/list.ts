...
export function useInventoryChangeList() {
    ...
    change_type: {
      ...
      'x-component-props': {
        ...
        options: [
          ...
          { label: t('inventory.CANCEL_STOCK_COUNT'), value: 'CANCEL_PHYSICAL_STOCK_TAKE' },
          { label: t('inventory.CANCEL_STOCK_CONSUMPTION'), value: 'CANCEL_STOCK_CONSUMPTION' },
          { label: t('inventory.EDIT_STOCK'), value: 'EDIT_STOCK' },
          { label: t('inventory.STOCK_TRANSFER_OUT'), value: 'STOCK_TRANSFER_OUT' },
          { label: t('inventory.SALES_DISPATCH'), value: 'SALES_DISPATCH' },
          { label: t('inventory.STOCK_TRANSFER_OUT_CANCEL'), value: 'STOCK_TRANSFER_OUT_CANCEL' },
          { label: t('inventory.SALES_RETURNED'), value: 'SALES_RETURNED' },
          { label: t('inventory.STOCK_PACK'), value: 'STOCK_PACK' },
          { label: t('inventory.PHYSICAL_STOCK_TAKE'), value: 'PHYSICAL_STOCK_TAKE' },
          { label: t('inventory.STOCK_TRANSFER_IN'), value: 'STOCK_TRANSFER_IN' },
          { label: t('inventory.PURCHASE_RETURNED'), value: 'PURCHASE_RETURNED' },
          { label: t('inventory.STOCK_CONSUMPTION'), value: 'STOCK_CONSUMPTION' },
          { label: t('inventory.STOCK_TRANSFER_IN_CANCEL'), value: 'STOCK_TRANSFER_IN_CANCEL' },
  ...
  return useCrud<InventoryChangeLogItem, InventoryChangeLogParams>({
    ...
    batchOperate: false,
    service: {
      query: inventoryChangeApi.getInventoryChangeLogList
    }
  });
}
