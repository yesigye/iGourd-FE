...
export const aa = [
  {
    value: 'EXPIRED_GOODS',
    label: 'spoilage.consumption-reason-enum.expired-products',
  },
  {
    value: 'DAMAGED_GOODS',
    label: 'spoilage.consumption-reason-enum.damaged-products',
  },
  {
    value: 'PERSONAL_USES',
    label: 'spoilage.consumption-reason-enum.personal-use',
  },
  {
    value: 'RAW_MATERIALS',
    label: 'spoilage.consumption-reason-enum.raw_materials',
  },
  {
    value: 'OTHERS',
    label: 'spoilage.consumption-reason-enum.others',
  },
];
