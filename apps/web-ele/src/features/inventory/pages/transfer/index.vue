...
import { useInventoryTransferList } from '../../hooks';
import { InventoryTransferDrawer, InventoryTransferDetail } from '../../components';
...
const [Drawer, drawerApi] = useIgourdDrawer({
  connectedComponent: InventoryTransferDrawer,
});
...
// 处理确认
const handleConfirmAction = (row: any) => {
  handleConfirm(row);
};
