...
const handleAutomaticReviewChange = (val) => {
  storeInfo.value.revenue_auto_approve_amount_limit = val ? 1000 : 0;
};
...
//
onMounted(() => {
  Promise.all([getStoreSetting()]).then(() => {
  ...
  <Page auto-content-height class="p-2">
    <section class="h-full text-sm">
      <div class="mb-4 flex items-center gap-2">
        <span class="bg-primary h-2.5 w-1 rounded-md"></span>
        {{ t('saleset.products-settings') }}
      </div>
      <!-- 设置项 -->
      <section class="bg-card pb-4 pl-5 pr-5 pt-4">
        ...
        >
          <div class="w-[290px] font-bold">
            {{ t('saleset.use-product-specifications-settings') }}
          </div>
        ...
        >
          <div class="w-[290px] font-bold">
            {{ t('saleset.use-stock-warning-settings') }}
          </div>
          <div class="flex gap-10">
            <!-- 插槽label -->
            <div class="w-[673px] text-[#999999]">
      ...
      <section class="bg-card pb-4 pl-5 pr-5 pt-4">
        ...
        >
          <div class="w-[290px] font-bold">
            {{ t('saleset.commodity-stock-less-than-zero-prohibited') }}
          </div>
        ...
        >
          <div class="w-[290px] font-bold">
            {{ t('saleset.temporary-repricing-of-sales') }}
          </div>
          <div class="flex gap-10">
            <!-- 插槽label -->
            <div class="w-[673px] text-[#999999]">
        ...
        >
          <div class="w-[290px] font-bold">
            {{ t('saleset.delete-the-cancel-order') }}
          </div>
          <div class="flex gap-10">
            <div class="w-[673px] text-[#999999]">
        ...
        >
          <div class="w-[290px] font-bold">
            {{ t('saleset.quick-tags-for-holding-orders') }}
          </div>
          <div class="flex gap-10">
            <!-- 插槽label -->
        ...
        >
          <div class="w-[290px] font-bold">
            {{ t('saleset.validity-time-of-pending-order') }}
          </div>
          <div class="flex gap-10">
            <!-- 插槽label -->
          ...
          <div class="flex min-w-[250px] justify-end">
            <ElSelect
              v-model="storeInfo.hold_order_ttl_mins"
              type="number"
              value-format="number"
            >
              <ElOption
        ...
        >
          <div class="w-[290px] font-bold">
            {{ t('saleset.daily-settlement-time') }}
          </div>
          <div class="flex items-center gap-10">
            <!-- 插槽label -->
          ...
          <div class="flex min-w-[250px] justify-end">
            <ElTimePicker
              ...
              v-model="storeInfo.daily_settlement_time"
            />
          </div>
        </div>
        <!-- ----------财会凭证自动审核------------ -->
        ...
        >
          <div class="w-[290px] font-bold">
            {{ t('saleset.automatic-review-of-accounting-notes') }}
          </div>
          <div class="flex items-center gap-10">
            <div class="w-[673px] text-[#999999]">
          ...
          <div class="flex min-w-[250px] justify-end gap-2">
            <ElSwitch
              v-model="isAutomaticReview"
              @change="handleAutomaticReviewChange"
            />
            <ElInput
              v-model="storeInfo.revenue_auto_approve_amount_limit"
              :disabled="!isAutomaticReview"
              type="number"
            />
          </div>
        </div>
