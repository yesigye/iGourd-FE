...
export function getCustomerListApi(data: CustomerInfoPageQueryParams) {
  return requestClient.post(
    `/merchant/basics/customer/page-list`,
    data,
  );
}
...
export function getCustomerDetailApi(id: string) {
  return requestClient.post(`/merchant/basics/customer/detail`, id);
}

// 创建客户
export function createCustomerApi(data: any) {
  return requestClient.post(`/merchant/basics/customer/create`, data);
}

// 更新客户
export function updateCustomerApi(data: any) {
  return requestClient.post(`/merchant/basics/customer/modify`, data);
}

// 删除客户
export function deleteCustomerApi(data: { customer_id_list: number[]; merchant_id?: number }) {
  return requestClient.post(`/merchant/basics/customer/remove`, data);
}

// 获取账户余额详情
export function getBalanceDetailApi(data: any) {
  return requestClient.post(
    `/merchant/basics/customer/customer-balance-change-log/page-list`,
    data,
  );
}
...
export function getRechargeDetailListApi(data: any) {
  return requestClient.post(
    `/merchant/basics/customer/customer-recharge/list-page`,
    data,
  );
}
...
export function getPointsDetailListApi(data: any) {
  return requestClient.post(
    `/merchant/basics/customer/point/exchange-gifts/page-list`,
    data,
  );
}
...
export function exchangePointsApi(data: any) {
  return requestClient.post(`/merchant/basics/customer/point/exchange-gifts`, data);
}
