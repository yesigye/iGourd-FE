      ...
      properties: {
        ...
        change_type: {
          ...
          'x-validator': [
            {
              required: true,
              message: "{{t('priceLevel.validate.changeType.required')}}",
            },
          ],
        },
        ...
        change_mode: {
          ...
          'x-validator': [
            {
              required: true,
              message: "{{t('priceLevel.validate.changeMode.required')}}",
            },
          ],
        },
        ...
        change_value: {
          ...
          'x-validator': [
            {
              required: true,
              message: "{{t('priceLevel.validate.changeValue.required')}}",
            },
          ],
        },
        ...
        relation_type: {
          ...
          'x-component': 'Select',
          enum: [
            { label: "{{t('priceLevel.enum.relation.all')}}", value: 'ALL' },
            {
          ...
          items: {
            ...
            properties: {
              ...
              id: {
                ...
                'x-component-props': {
                  filterable: true,
                  placeholder: "{{t('priceLevel.placeholder.productGroup')}}",
                },
                enum: [],
              },
              remove: {
          ...
          items: {
            ...
            properties: {
              ...
              id: {
                ...
                'x-component-props': {
                  filterable: true,
                  placeholder: "{{t('priceLevel.placeholder.productLabel')}}",
                },
                enum: [],
              },
              remove: {
        ...
        effective_time: {
          ...
          'x-validator': [
            {
              required: true,
              message: "{{t('priceLevel.validate.effectiveTime.required')}}",
            },
          ],
        },
        ...
        expiratoin_time: {
          ...
          'x-validator': [
            {
              required: true,
              message: "{{t('priceLevel.validate.expirationTime.required')}}",
            },
            // {
            //   validator:
