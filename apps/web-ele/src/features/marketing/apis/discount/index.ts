...
export function createDiscountApi(data: any) {
  return requestClient.post('/v1/merchant/marketing/discount/create', data);
}

// 更新折扣
export function updateDiscountApi(data: any) {
  return requestClient.post('/v1/merchant/marketing/discount/modify', data);
}

// 删除折扣
export function deleteDiscountApi(discount_id_list: (number | string)[]) {
  return requestClient.post('/v1/merchant/marketing/discount/remove', {
    discount_id_list,
  });
}
...
export function updateDiscountStatusApi(data: any) {
  return requestClient.post('/v1/merchant/marketing/discount/update-status', data);
}

// 获取折扣详情
export function getDiscountDetailApi(discount_id: number | string) {
  return requestClient.get(`/v1/merchant/marketing/discount/detail/${discount_id}`);
}
