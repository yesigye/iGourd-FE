...
export type EventEmitter<T extends Record<string, unknown>> = BiArgEmitter<
  T,
  RequiredKeys<T>
> &
  MonoArgEmitter<T, OptionalKeys<T>>;
...
export type ComponentSize = 'large' | 'medium' | 'mini' | 'small';

export type StyleValue = Array<StyleValue> | CSSProperties | string;
